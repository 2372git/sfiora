...
$glagol_mis   = mis($glagol, $b-1);
$glagol_memis = memis($glagol, $b-1);
$glagol_mismi = mismi($glagol, $b-1);
...
$content .= "<font size=20> = " . $glagol_mis . "<br>";
$content .= " = " . $glagol_memis . "<br>";
$content .= " = " . $glagol_mismi . "?<br></font>";
