...
$content .= "<center><font size=20 onclick=trans1.style.visibility='visible'> " . $kim_rus . " </font> ";
...
$content .= "<h1 style='visibility:hidden' id='transl'>" . $glagol_iyor . " " . $mi . "? <br> $addline &nbsp; </h1><br>";
